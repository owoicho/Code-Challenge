<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="CodeChallenge.AdminPage" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <section id="main" class="wrapper">
            <div class="inner">
                <h1 class="major">Admin Page </h1>
                <form id="form1" runat="server">
                    <div class="row uniform">
                        <div class="6u 12u$(xsmall)">
                            <asp:TextBox ID="txtuser" runat="server" value="" placeholder="Username"></asp:TextBox>
                            
                        </div>
                        <div class="6u$ 12u$(xsmall)">
                            <asp:TextBox ID="txtpass" runat="server" value="" placeholder=" Password" TextMode ="Password"></asp:TextBox>
                        ...
                        <div class="12u$">
                            <ul class="actions">
                                <li>
                                    <asp:Button ID="btnSubmit1"  runat="server" OnClick="Button1_Click" Text="Login" /></li>
                                <li>
